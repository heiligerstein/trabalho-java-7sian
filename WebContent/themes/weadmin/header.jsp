...
<div class="content_wrapper">
	...
	<div id="header">
		...
		<div id="search">
		 ...
		 -->
		<div id="account_info">
			<img src="<%= path %>images/icon_online.png" alt="Online" class="mid_align">
				<%= (session.getAttribute("nome") != null) ?
					"Olá <a href=\"\">" + session.getAttribute("nome") + "</a> | <a href=\"Usuario?op=auth&logout=1\">Sair</a>" :
					"<a href=\"Usuario?op=auth\">Login</a>"
				%>
		</div>
	</div>
	<!-- End header -->
	...
	<%= (session.getAttribute("nome") == null) ? "<div id=\"left_menu\" style=\"display: none;\">" : "<div id=\"left_menu\">" %>
		<a href="javascript:;" id="hide_menu">«</a>
		<ul role="tablist" class="ui-accordion ui-widget ui-helper-reset" id="main_menu">
			<li class="ui-accordion-li-fix"><a tabindex="0" aria-expanded="true" role="tab" class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" href="Usuario?op=following"><span class="ui-icon ui-icon-triangle-1-e"></span><span class="ui-icon ui-icon-triangle-1-e"></span><img src="<%= path %>images/group_go.png" alt="Home">Following</a></li>
			<li class="ui-accordion-li-fix"><a tabindex="0" aria-expanded="true" role="tab" class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" href="Usuario?op=followers"><span class="ui-icon ui-icon-triangle-1-e"></span><span class="ui-icon ui-icon-triangle-1-e"></span><img src="<%= path %>images/group.png" alt="Home">Followers</a></li>
			<li class="ui-accordion-li-fix"><a tabindex="0" aria-expanded="true" role="tab" class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" href="Usuario?op=list"><span class="ui-icon ui-icon-triangle-1-e"></span><span class="ui-icon ui-icon-triangle-1-e"></span><img src="<%= path %>images/icon_users.png" alt="Home">Listar Todos</a></li>
			<li class="ui-accordion-li-fix">
				<a href="#" class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" role="tab" aria-expanded="true" tabindex="0"><span class="ui-icon ui-icon-triangle-1-e"></span><span class="ui-icon ui-icon-triangle-1-e"></span><img alt="Users" src="<%= path %>images/cog.png">Configurações</a>
				<ul style="display: none;" role="tabpanel" class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active">
					<li><a href="Usuario?op=edit&id=<%= (Integer) session.getAttribute("id") %>">Editar cadastro</a></li>
					<!-- 
