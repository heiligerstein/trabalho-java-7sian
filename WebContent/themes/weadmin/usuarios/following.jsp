...
<div class="onecolumn">
	<div class="header">
		<span style="cursor: n-resize;">Following (Pessoas que eu sigo...)</span>
	</div>
	<br class="clear">
	<div class="content" style="display: block;">
		<table width="100%" cellspacing="0" cellpadding="0" class="data">
			...
			<tbody>
				...
				%>
				<%
					for (UsuarioModel us : usuario.getaQuemEuSigo()) {
				%>
					<tr>
						<td><%= us.getId() %></td>
						<td><%= us.getNome() %></td>
						...
						<td><%= us.getCidade() %></td>
						<td>
							<a href="Usuario?op=nao_seguir&id_following=<%= us.getId() %>"><img class="help" alt="deixar de seguir" src="<%= path %>images/user_delete.png" original-title="Deixar de seguir"></a>							
						</td>
					</tr>
				<% } %>
			</tbody>
